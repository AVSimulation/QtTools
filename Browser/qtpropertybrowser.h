...
class QTTOOLS_API QtAbstractPropertyManager : public QObject
{
    Q_OBJECT
public:
...
class QTTOOLS_API QtAbstractEditorFactoryBase : public QObject
{
    Q_OBJECT
public:
...
class QTTOOLS_API QtAbstractEditorFactory : public QtAbstractEditorFactoryBase
{
public:
...
class QTTOOLS_API QtBrowserItem
{
public:
...
class QTTOOLS_API QtAbstractPropertyBrowser : public QWidget
{
    Q_OBJECT
public:
