...
class QTTOOLS_API QtVariantProperty : public QtProperty
{
public:
    ~QtVariantProperty();
...
class QTTOOLS_API QtVariantPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
...
class QTTOOLS_API QtVariantEditorFactory : public QtAbstractEditorFactory<QtVariantPropertyManager>
{
    Q_OBJECT
public:
...
template class QTTOOLS_API QtAbstractEditorFactory<QtVariantPropertyManager>;
